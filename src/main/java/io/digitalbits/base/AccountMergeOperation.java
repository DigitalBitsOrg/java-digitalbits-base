...
import io.digitalbits.base.xdr.Operation.OperationBody;
import io.digitalbits.base.xdr.OperationType;

import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Represents <a href="https://developer.digitalbits.io/guides/concepts/list-of-operations.html#account-merge" target="_blank">AccountMerge</a> operation.
...
public class AccountMergeOperation extends Operation {
    ...
    OperationBody toOperationBody() {
        OperationBody body = new io.digitalbits.base.xdr.Operation.OperationBody();
