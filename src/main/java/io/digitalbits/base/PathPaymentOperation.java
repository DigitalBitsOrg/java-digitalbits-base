...
import io.digitalbits.base.xdr.Int64;
import io.digitalbits.base.xdr.OperationType;
import io.digitalbits.base.xdr.PathPaymentOp;

import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Represents <a href="https://developer.digitalbits.io/guides/concepts/list-of-operations.html#path-payment" target="_blank">PathPayment</a> operation.
...
public class PathPaymentOperation extends Operation {
  ...
  io.digitalbits.base.xdr.Operation.OperationBody toOperationBody() {
    ...
    // path
    io.digitalbits.base.xdr.Asset[] path = new io.digitalbits.base.xdr.Asset[this.path.length];
