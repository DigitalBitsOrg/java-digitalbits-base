...
import io.digitalbits.base.xdr.SetOptionsOp;
import io.digitalbits.base.xdr.Signer;
import io.digitalbits.base.xdr.String32;
import io.digitalbits.base.xdr.Uint32;

/**
 * Represents <a href="https://developer.digitalbits.io/guides/concepts/list-of-operations.html#set-options">SetOptions</a> operation.
 * @see <a href="https://developer.digitalbits.io/guides/concepts/list-of-operations.html">List of Operations</a>
 */
public class SetOptionsOperation extends Operation {
  ...
  /**
   * Indicates which flags to clear. For details about the flags, please refer to the <a href="https://developer.digitalbits.io/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
   */
  ...
  /**
   * Indicates which flags to set. For details about the flags, please refer to the <a href="https://developer.digitalbits.io/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
   */
  ...
  /**
   * A number from 0-255 representing the threshold this account sets on all operations it performs that have <a href="https://developer.digitalbits.io/guides/concepts/multi-sig.html" target="_blank">a low threshold</a>.
   */
  ...
  /**
   * A number from 0-255 representing the threshold this account sets on all operations it performs that have <a href="https://developer.digitalbits.io/guides/concepts/multi-sig.html" target="_blank">a medium threshold</a>.
   */
  ...
  /**
   * A number from 0-255 representing the threshold this account sets on all operations it performs that have <a href="https://developer.digitalbits.io/guides/concepts/multi-sig.html" target="_blank">a high threshold</a>.
   */
  ...
  public static class Builder {
     ...
     * @param clearFlags For details about the flags, please refer to the <a href="https://developer.digitalbits.io/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
     * @return Builder object so you can chain methods.
     */
     ...
     * @param setFlags For details about the flags, please refer to the <a href="https://developer.digitalbits.io/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
     * @return Builder object so you can chain methods.
     */
    ...
    /**
     * Sets the account's home domain address used in <a href="https://developer.digitalbits.io/guides/concepts/federation.html" target="_blank">Federation</a>.
